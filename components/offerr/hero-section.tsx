    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transform: logoPulsed ? "scale(1.05)" : "scale(1)",
      ...
      <div
        ...
        style={{ opacity: textVisible ? 1 : 0, transform: textVisible ? "translateY(0)" : "translateY(14px)", transition: "all 1s ease" }}
      >
      ...
      <form onSubmit={handleSubmit} className="relative w-full max-w-lg"
        style={{ opacity: searchVisible ? 1 : 0, transform: searchVisible ? "translateY(0) scaleX(1)" : "translateY(8px) scaleX(0.96)", transition: "all 0.8s cubic-bezier(0.34,1.56,0.64,1)" }}
      >
        <canvas
          ref={ringCanvasRef}
        ...
        <div
          className="absolute -inset-1.5 rounded-2xl pointer-events-none transition-opacity duration-700"
          style={{
            opacity: searchFocused ? 1 : 0.2,
        ...
        <div
          className={`relative flex items-center rounded-xl border transition-all duration-500 ${searchFocused ? "neon-border-strong bg-[#080C10]" : "border-[rgba(0,228,255,0.08)] bg-[#0A0E14]"}`}
          style={{ transform: searchFocused ? "scale(1.02)" : "scale(1)", transition: "transform 0.3s ease, box-shadow 0.5s ease, border-color 0.5s ease" }}
        >
          <Search
        ...
        <p className="text-center text-[11px] text-[#6C7A89]/25 mt-3 font-mono transition-opacity duration-500"
      ...
      {/* Stats row */}
      <div
        className="flex flex-wrap items-center justify-center gap-10 md:gap-14 mt-16"
        style={{ opacity: searchVisible ? 1 : 0, transform: searchVisible ? "translateY(0)" : "translateY(16px)", transition: "opacity 1s ease 0.4s, transform 1s ease 0.4s" }}
      >
        {[
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center"
        style={{ opacity: searchVisible ? 0.25 : 0, transition: "opacity 1s ease 1s" }}>
